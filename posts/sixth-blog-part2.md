...
I think in the category of Sianne Ngai’s aesthetic, would fall under her “zany” category. Ngai’s Zany concept can be characterized by unpredictability and absurdity. Glitching have that element of unpredictability and absurdity with the image being display not like normal. The glitches have that uncertainty and unpredicted aspect that distorts the image. Ngai’s zany is also a reference to the world full of pressure and anxiety, the glitches are pressure that affects the picture and tweaking the picture.

Glitch in my opinion, it does represent the concept of effective complexity. The pattern of glitches creates that level of chaos and the glitch is based on an order level. That combination sounds terrible but it makes a balance of effective complexity. Like in physics, if there are two equal forces, with opposite directions, acting on an object, the object will stand still to create that balance.
